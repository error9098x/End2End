...
if (options[choice] == 'Send encrypted message') {
...
} else if (options[choice] == 'Decrypt your message') {
...
function initializeArrays() {
    options = ['Send encrypted message', 'Decrypt your message'];
    algo = [ "aes128", "aes192", "aes256", "des3", "desx", "rc2"];
}

function displayWelcomeText() {
    console.log("Welcome to Encrypted Chats!")
}
